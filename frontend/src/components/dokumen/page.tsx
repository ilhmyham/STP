  ...
  return (
    <div className="flex flex-col w-[300px] md:w-[600px] lg:w-[884px] p-5 md:px-[47px] md:py-[38px] border-[0.5px] border-[#BDCED5] rounded-[14px] md:rounded-[16px] shadow-sm gap-3">
      <div className="space-y-1">
        <p className="text-base md:text-[22px] text-[#29334D] font-Fustat font-medium">{title}</p>
      ...
      >
        ...
        />
        <span className="text-white text-[12px] sm:text-base font-semibold font-Fustat">Unduh Dokumen</span>
      </a>
    </div>
  )
}
