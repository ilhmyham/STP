        ...
        <div className="p-10">
          <div className="space-y-8">
            <div className="text-start">
              <h1 className="text-[32px] font-medium text-[#3b4f81]">Selamat datang,</h1>
              <h2 className="text-[32px] font-medium text-[#3b4f81]">Kembali!</h2>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="text-center text-[#3b4f81] text-base font-medium">
              Belum punya akun?{" "}
          ...
          <div className="p-10">
            <div className="space-y-8">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="text-center text-[#3b4f81] text-[14px] font-medium">
                Belum punya akun?{" "}
                <Link href="signup" className="text-blue-500 hover:underline">
                  Daftar
                </Link>
